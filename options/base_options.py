...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', type=str, default='/home/cljun27/longleaf/BCP_npy', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
