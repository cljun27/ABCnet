...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--epoch_count', type=int, default=31, help='the starting epoch count, we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>, ...')
        ...
        self.parser.add_argument('--niter', type=int, default=800, help='# of iter at starting learning rate')
        ...
        self.parser.add_argument('--no_lsgan', default=False, help='do *not* use least square GAN, if false, use vanilla GAN')
        self.parser.add_argument('--lambda_A', type=float, default=100.0, help='weight for cycle loss (A -> B -> A)')
        self.parser.add_argument('--lambda_B', type=float, default=1000.0, help='weight for cycle loss (B -> A -> B)')
        self.parser.add_argument('--lambda_C', type=float, default=1, help='weight for cycle loss (A -> B -> A)')
